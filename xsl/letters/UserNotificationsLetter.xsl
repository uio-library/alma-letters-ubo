    ...
    <xsl:when test="notification_type = 'ferdigstudert'">
      <p>
        <xsl:call-template name="multilingual"><!-- header.xsl -->
          ...
          <xsl:with-param name="nb" select="'Du får denne mailen fordi du har lånt bøker fra Universitetsbiblioteket i Oslo, og brukerkontoen din viser at du ikke er registrert student og betalt for våren 2019. Brukeren din i biblioteksystemet har dermed fått en utløpsdato. Hvis du ikke er aktiv student lenger trenger vi å oppdatere informasjonen din knyttet til pålogging i Oria, studentkort o.l. Fint om du tar en tur innom skranken neste gang du er i biblioteket for å se på dette hvis du fortsatt ønsker å bruke Universitetsbiblioteket.'"/>

          <xsl:with-param name="nn" select="'Du får denne e-posten då du har lånt bøker frå Universitetsbiblioteket i Oslo, og brukarkontoen din viser at du ikkje er registrert student for våren 2019.
