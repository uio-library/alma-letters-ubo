...
<xsl:choose>
  ...
  <td width="50%" align="right">
   <xsl:for-each select="notification_data/research_organization">
  <table>
  <xsl:attribute name="style">
   <xsl:call-template name="listStyleCss" /> <!-- style.xsl -->
  </xsl:attribute>
   <tr><td><xsl:value-of select="organization_name"/></td></tr>
   <tr><td><xsl:value-of select="main_address/line1"/></td></tr>
   <tr><td><xsl:value-of select="main_address/line2"/></td></tr>
   <tr><td><xsl:value-of select="main_address/city"/></td></tr>
   <tr><td><xsl:value-of select="main_address/postal_code"/></td></tr>
   <tr><td><xsl:value-of select="main_address/country"/></td></tr>
  </table>
 </xsl:for-each>
  </td>
 </tr>
